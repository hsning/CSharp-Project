<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Patient.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="Demographic.aspx.cs" Inherits="Application.Patient.Demographic" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div class="title">
        <asp:Label ID="Label1" runat="server" Text="Add Demographic" CssClass="pageTitle"></asp:Label>
        <hr />
        <asp:Label runat="server" ID="StatusLabel" ForeColor="Green" Font-Size="26px"></asp:Label>
